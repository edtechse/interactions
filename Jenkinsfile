pipeline {
    ...
    environment {
        ...
        IMAGE_REPO_NAME="interactions-service-repo"
        IMAGE_TAG="latest"
    ...
    stages {   
      stage('Logging into AWS ECR') {
        ...
        stage('Cloning Git') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '', url: 'https://github.com/edtechse/interactions.git']]])
            }
        }
